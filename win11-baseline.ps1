...
# Section toggles - Set to $false to skip individual sections
$EnableSection1 = $true   # Privacy: Diagnostics & Feedback
$EnableSection2 = $true   # Privacy: Activity History & Connected Devices
$EnableSection3 = $true   # Privacy: Advertising ID & General
$EnableSection4 = $true   # Privacy: Location
$EnableSection5 = $true   # Privacy: Search & Web
$EnableSection6 = $true   # Privacy: Background apps
$EnableSection7 = $true   # Security: Windows Defender & SmartScreen
$EnableSection8 = $true   # Security: Firewall
$EnableSection9 = $true   # Security: BitLocker / Device Encryption
$EnableSection10 = $true  # System: Windows Update hygiene
$EnableSection11 = $true  # System: Startup items & tips/suggestions
$EnableSection12 = $true  # System: Clipboard sync & Nearby sharing
$EnableSection13 = $true  # UI: Taskbar Widgets
$EnableSection14 = $true  # Browser defaults (manual note)
$EnableSection15 = $true  # Restart Explorer
